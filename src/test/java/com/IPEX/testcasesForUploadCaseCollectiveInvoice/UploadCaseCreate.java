...
public class UploadCaseCreate extends TestBase {
    ...
    public void createManualCase() {
        try {
            ...
            Thread.sleep(3000);
            for (WebElement e5 : suggList1) {
                if (e5.getText().equalsIgnoreCase("New Stage Inspector")) {
                    e5.click();
            ...
            SimpleDateFormat ppdf5 = new SimpleDateFormat("dMyyyy");
            Date currentDate = new Date();
            String formattedDateCurrent = ppdf5.format(currentDate);
