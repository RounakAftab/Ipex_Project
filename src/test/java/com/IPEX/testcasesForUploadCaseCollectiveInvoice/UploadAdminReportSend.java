...
public class UploadAdminReportSend extends TestBase {

    public JavascriptExecutor jse2;
    private static final Logger logger = Logger.getLogger(UploadAdminReportSend.class.getName());
    ...
    public void adminSendInvoice() throws Exception {
        ...
        try {
            ...
            ExtentReporterNG.addStep("QC confirmation Done Successfully");
                ...
                Thread.sleep(2000);                if ("READY FOR BILLING".equalsIgnoreCase(getInvoiceType)) {
