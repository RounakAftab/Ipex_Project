...
public class CaseCenterSingleInvoiceCase extends TestBase {

	private static final Logger logger = Logger.getLogger(CaseCenterSingleInvoiceCase.class.getName());
