...
public class InspectorActionManualCase extends TestBase {
    ...
    public void InspectorAction() {
        try {
            ...
            logger.info("Clicking on last created case: " + caseID);
            ...
            WebElement caseID1= driver.findElement(By.cssSelector(OR.getProperty("clickOnCaseIDField")));
            Thread.sleep(2000);
            caseID1.sendKeys(caseID);
            ...
            ExtentReporterNG.addStep("Scrolling to and clicking 'ADD MORE'.");
