...
public class InspectorActionMailedCase extends TestBase {
    private static final Logger logger = Logger.getLogger(InspectorActionMailedCase.class.getName());
    ...
    public void InspectorAction() {
        try {
            ...
            logger.info("Clicking on last created case: " + mailboxCaseID);
            ...
            ExtentReporterNG.addStep("Clicked on last created case"+ mailboxCaseID);
